...
const formatPrompt = async (userInput: string): Promise<string> => {
  return await promptTemplate.format({ question: userInput }); // {question:question} is the same as {question}
};
