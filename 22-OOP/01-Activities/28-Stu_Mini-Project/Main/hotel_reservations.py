...
class Hotel:
    ...
    def search_rooms(self):
        """Print the details of all available rooms."""
    ...
    def make_reservation(self, room_number):
        """
        Reserve a room with the given room number.
    ...
    def cancel_reservation(self, room_number):
        """
        Cancel a reservation for a room with the given room number.

        Args:
            room_number (int): The number of the room to cancel the
            reservation for.
        """
        room = None
        ...
        if room:
            ...
            print("No reservation found for that room.")
