...
grocery_db_path = current_directory / "SHMEEesources" / "grocery_data.csv"
...
def manage_csv_files(file, header_row, data):
    ...
    try:
        ...
        with open(file, 'w', encoding='utf-8', newline="") as data_file:
        ...
        print(f"Could not create '{file}' ; Directory does not exist.\n")
    except FileNotFoundError:
        print("Uh oh! No such directorY!")
