...
# // below is javascript
# const myList = ["turkey", "stuffing", "more stuffing", "cranberries"];
# myList = ["ham", "potatoes"] ==> not allowed
# myList.push("sweet potatoes");
