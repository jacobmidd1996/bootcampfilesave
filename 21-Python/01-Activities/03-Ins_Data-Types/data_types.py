...
print("user_name", user_name, "is type", type(user_name))
...
print("The value of age", age, "is type", type(age))
...
print("The value of grocery_bill", grocery_bill, "is type", type(grocery_bill))
...
print("The total grocery bill for the year is $" + str(grocery_bill * 52))
