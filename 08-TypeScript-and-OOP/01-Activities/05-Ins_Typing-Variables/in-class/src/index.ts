...
const myStringWelcome = 'Hello World'; // When defining a variable, you can specify the type of data it will hold by using a colon followed by the type. This is called type annotation.
let myVar1 : string;
...
logTheNumberPlusTen(myUnknown);
myUnknown = 'Hello World';
logTheNumberPlusTen(myUnknown);

function logTheNumberPlusTen(someNumber: unknown) {
...
console.log(typeof myUnknown); // this will execute ONLY in javascript. and here, it will be string
// typeof will never print the string "unknown"
