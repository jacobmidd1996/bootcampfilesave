...
const planet = {
  ...
  showWarning: function (name) {
    console.log("Space junk falls into Earth's atmosphere at a rate of about one a day, " + name);
  }
};
...
planet.tellFunFact();
planet.showWarning("Dan");
planet.showWarning();
planet.showWarning;
planet['showWarning']("Geraldo");

const theFunctionIWantToCall = 'tellFunFact';
planet[theFunctionIWantToCall]();
