...
studentName = 'Hilary';
console.log(`First student name is ${studentName}`);
console.log(`First student age is ${studentAge}`);
console.log(`Student: ${studentName}; Age: ${studentAge}; Hello!`);
console.log("First student age again is " + studentAge);
