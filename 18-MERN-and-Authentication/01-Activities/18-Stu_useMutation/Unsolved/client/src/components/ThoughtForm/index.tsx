...
const ThoughtForm = () => {
  ...
  const handleFormSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      // TODO: Add a comment describing why we no longer need to reload the page/ refetch queries auto reloads page after mutation. also the form state will refresh the component
      setCharacterCount(0);
      setFormState({
        thoughtText: "",
        thoughtAuthor: "",
